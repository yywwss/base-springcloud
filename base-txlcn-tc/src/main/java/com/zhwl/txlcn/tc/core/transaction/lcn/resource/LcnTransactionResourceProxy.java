 ...
 */
package com.zhwl.txlcn.tc.core.transaction.lcn.resource;

import com.codingapi.txlcn.common.exception.TCGlobalContextException;
import com.zhwl.txlcn.tc.aspect.weave.ConnectionCallback;
import com.zhwl.txlcn.tc.core.DTXLocalContext;
import com.zhwl.txlcn.tc.core.context.TCGlobalContext;
import com.zhwl.txlcn.tc.support.resouce.TransactionResourceProxy;
