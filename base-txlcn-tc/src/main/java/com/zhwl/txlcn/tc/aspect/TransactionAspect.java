 ...
 */
package com.zhwl.txlcn.tc.aspect;

import com.zhwl.txlcn.tc.annotation.*;
import com.zhwl.txlcn.tc.aspect.weave.DTXLogicWeaver;
import com.zhwl.txlcn.tc.config.TxClientConfig;
...
public class TransactionAspect implements Ordered {
     ...
     */
    @Pointcut("@annotation(com.zhwl.txlcn.tc.annotation.TxTransaction)")
     ...
     */
    @Pointcut("@annotation(com.zhwl.txlcn.tc.annotation.LcnTransaction)")
     ...
     */
    @Pointcut("@annotation(com.zhwl.txlcn.tc.annotation.TxcTransaction)")
     ...
     */
    @Pointcut("@annotation(com.zhwl.txlcn.tc.annotation.TccTransaction)")
    ...
    @Around("this(com.zhwl.txlcn.tc.annotation.ITxTransaction) && execution( * *(..))")
