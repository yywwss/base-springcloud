...
import com.zhwl.config.TxManagerConfig;
import com.zhwl.core.storage.FastStorage;
import com.zhwl.core.storage.FastStorageProvider;
import com.zhwl.core.storage.redis.RedisStorage;
...
@EnableJpaRepositories("com.zhwl.support.db.jpa")
@EntityScan("com.zhwl.support.db.domain")
